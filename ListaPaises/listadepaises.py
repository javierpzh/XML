...
#EJERCICIO 1
if opcion==1:
    for pais in listar_informacion(lista1,lista2):
        print(pais)

#EJERCICIO 2
if opcion==2:
    print(contar_informacion(lista2))

#EJERCICIO 3
if opcion==3:
    cadena=str(input("Introduce un país: "))
    for pais in buscar_informacion(lista2,cadena):
        print(pais)

#EJERCICIO 4
if opcion==4:
    cadena=str(input("Introduce un idioma: "))
    for idioma in buscar_informacion_relacionada(lista3,cadena):
        print(idioma)

#EJERCICIO 5
if opcion==5:
    cadena=str(input("Introduce una moneda: "))
    for moneda in buscar_moneda(lista4,cadena):
        print(moneda)
